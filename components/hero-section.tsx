      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center">
        ...
        >
          ...
          <Avatar className="h-[200px] w-[200px] border-4 border-white/20 shadow-2xl">
            ...
            <AvatarFallback className="text-3xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white">CN</AvatarFallback>
          </Avatar>
        </motion.div>
        ...
        <motion.h1
          ...
          className="text-5xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-slate-900 to-slate-600 dark:from-white dark:to-slate-400 sm:text-7xl mb-4 drop-shadow-sm"
        >
          Chawput Nawakalanu
        </motion.h1>
